  ...
  <div>
    ...
    <div className="ig-grid ig-grid-cols-2 md:ig-grid-cols-4 ig-gap-4">
      <div className="ig-text-center">
        <div className="ig-bg-brand ig-w-20 ig-h-20 ig-rounded ig-mx-auto ig-mb-2 ig-transition hover:ig-bg-secondary"></div>
        <code className="ig-text-xs ig-text-muted">ig-transition</code>
      </div>

      <div className="ig-text-center">
        <div className="ig-bg-brand ig-w-20 ig-h-20 ig-rounded ig-mx-auto ig-mb-2 ig-transition-fast hover:ig-bg-secondary"></div>
        <code className="ig-text-xs ig-text-muted">ig-transition-fast</code>
      </div>

      <div className="ig-text-center">
        <div className="ig-bg-brand ig-w-20 ig-h-20 ig-rounded ig-mx-auto ig-mb-2 ig-transition-slow hover:ig-bg-secondary"></div>
        <code className="ig-text-xs ig-text-muted">ig-transition-slow</code>
      </div>

      <div className="ig-text-center">
        <div className="ig-bg-brand ig-w-20 ig-h-20 ig-rounded ig-mx-auto ig-mb-2 ig-transition-slower hover:ig-bg-secondary"></div>
  ...
  <div>
    ...
    <div className="ig-grid ig-grid-cols-1 md:ig-grid-cols-2 ig-gap-6">
      <div className="ig-bg-surface ig-p-4 ig-rounded-lg ig-border ig-border-default">
        ...
        <button className="ig-bg-brand ig-text-on-brand ig-px-4 ig-py-2 ig-rounded ig-transition-colors ig-duration-300 hover:ig-bg-secondary">
          Cambio de color
        </button>
      </div>
      ...
      <div className="ig-bg-surface ig-p-4 ig-rounded-lg ig-border ig-border-default">
        ...
        <div className="ig-bg-brand ig-w-20 ig-h-12 ig-rounded ig-transition-opacity ig-duration-300 hover:ig-opacity-50"></div>
      </div>

      <div className="ig-bg-surface ig-p-4 ig-rounded-lg ig-border ig-border-default">
        <code className="ig-text-sm ig-text-muted ig-block ig-mb-3">ig-transition-shadow</code>
        <div className="ig-bg-surface ig-border ig-border-default ig-w-20 ig-h-12 ig-rounded ig-shadow ig-transition-shadow ig-duration-300 hover:ig-shadow-xl"></div>
      </div>

      <div className="ig-bg-surface ig-p-4 ig-rounded-lg ig-border ig-border-default">
        <code className="ig-text-sm ig-text-muted ig-block ig-mb-3">ig-transition-transform</code>
        <div className="ig-bg-brand ig-w-20 ig-h-12 ig-rounded ig-transition-transform ig-duration-300 hover:ig-scale-110"></div>
      </div>

      <div className="ig-bg-surface ig-p-4 ig-rounded-lg ig-border ig-border-default">
        <code className="ig-text-sm ig-text-muted ig-block ig-mb-3">ig-transition-all</code>
        <div className="ig-bg-brand ig-w-20 ig-h-12 ig-rounded ig-shadow ig-transition-all ig-duration-300 hover:ig-bg-secondary hover:ig-shadow-xl hover:ig-scale-105"></div>
      </div>

      <div className="ig-bg-surface ig-p-4 ig-rounded-lg ig-border ig-border-default">
        <code className="ig-text-sm ig-text-muted ig-block ig-mb-3">ig-transition-none</code>
        <div className="ig-bg-brand ig-w-20 ig-h-12 ig-rounded ig-transition-none hover:ig-bg-secondary">
    ...
    <div className="ig-space-y-4">
      {[
        ...
        <div key={clase} className="ig-flex ig-items-center ig-gap-4">
          ...
          <div className={`ig-bg-brand ig-h-8 ig-w-16 ig-rounded ig-transition-all ${clase} hover:ig-w-64`}></div>
  ...
  <div>
    ...
    <div className="ig-space-y-4">
      {[
        ...
        <div key={clase} className="ig-flex ig-items-center ig-gap-4">
          <code className="ig-text-sm ig-text-muted ig-w-32">{clase}</code>
          <div className={`ig-bg-secondary ig-h-8 ig-w-16 ig-rounded ig-transition-all ig-duration-500 ${clase} hover:ig-w-64`}></div>
  ...
  <div>
    ...
    <div className="ig-space-y-4">
      {[
        ...
        <div key={clase} className="ig-flex ig-items-center ig-gap-4">
          <code className="ig-text-sm ig-text-muted ig-w-32">{clase}</code>
          <div className={`ig-bg-success ig-h-8 ig-w-16 ig-rounded ig-transition-all ig-duration-300 ${clase} hover:ig-w-48 hover:ig-bg-warning`}></div>
...
export const EjemplosBotones = () => (
  <div>
    ...
    <div className="ig-flex ig-flex-wrap ig-gap-4">
      <button className="ig-btn ig-btn-brand ig-transition-all ig-duration-200 hover:ig-shadow-lg hover:ig--translate-y-0.5">
        Elevación
      </button>

      <button className="ig-btn ig-btn-secondary ig-transition-all ig-duration-200 hover:ig-scale-105">
        Escalar
      </button>

      <button className="ig-btn ig-btn-outline ig-transition-all ig-duration-300 hover:ig-bg-brand hover:ig-text-on-brand hover:ig-border-brand">
        Cambio completo
      </button>

      <button className="ig-bg-transparent ig-border-2 ig-border-brand ig-text-brand ig-px-4 ig-py-2 ig-rounded ig-transition-all ig-duration-300 hover:ig-bg-brand hover:ig-text-on-brand hover:ig-shadow-lg">
        Relleno animado
      </button>
    </div>
  </div>
...
export const TransicionesDeGrupo = () => (
  <div>
    ...
    <div className="ig-grid ig-grid-cols-1 md:ig-grid-cols-2 ig-gap-6">
      <div className="ig-group ig-card ig-cursor-pointer hover:ig-shadow-xl ig-transition-shadow">
        <div className="ig-card-body">
          <h3 className="ig-font-semibold ig-text-heading ig-mb-2 group-hover:ig-text-brand ig-transition-colors">
            Título que cambia
          </h3>
          ...
          <span className="ig-inline-block ig-mt-4 ig-text-brand ig-transition-transform group-hover:ig-translate-x-2">
            Ver más →
          </span>
        </div>
      </div>
