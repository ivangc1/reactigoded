# C-04 — `useDropdown`/`useTabs`/etc accidentalmente públicos
...
- 6 hooks: `useAccordion`, `useAccordionItem`, `useDropdown`, `useSidebar`, `useTabs`, `useToast`
- 6 ContextValues: `AccordionContextValue`, `AccordionItemContextValue`, `DropdownContextValue`, `SidebarContextValue`, `TabsContextValue`, `ToastContextValue`
