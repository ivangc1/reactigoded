...
DropdownContextValue            ← pareja tipada de useDropdown
...
import {} from "reactigoded/dist/components/Dropdown/dropdownSelectors";
...
```
test-negative-check.tsx(3,16): error TS2307: Cannot find module 'reactigoded/dist/components/Dropdown/dropdownSelectors' or its corresponding type declarations.
